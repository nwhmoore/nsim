...
#[test]
fn runge_kutta_convergence_and_time_reversibility() {
    const EXPECTED_ORDER: f64 = 4.0;
    ...
    let steps_per_periods = [100, 200, 400, 800, 1_600, 3_200];
    ...
    assert!(
        ...
        "convergence order {slope} not close to {EXPECTED_ORDER}"
    )
}
